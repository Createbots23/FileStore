...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "anime_boy0007")

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7177667220"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002207347398"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002235901310"))
...
try:
    ADMINS=[7177667220]
    for x in (os.environ.get("ADMINS", "7177667220").split()):
        ADMINS.append(int(x))
except ValueError:
